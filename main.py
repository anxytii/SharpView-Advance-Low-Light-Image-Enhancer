...
ENHANCED_FOLDER = r'C:\Users\Saksham\Desktop\SharpView\SharpView-Advance-Low-Light-Image-Enhancer\enhanced'
...
def delete_file():
    ...
    file_path = r"C:\Users\Saksham\Desktop\SharpView\SharpView-Advance-Low-Light-Image-Enhancer\iterative_output.ppm"
...
def enhance_image():
    ...
    try:
        ...
        subprocess.run([
            r"C:\Users\Saksham\anaconda3\envs\sharpview\python.exe",
            'automation.py',
            input_image_path
        ], check=True)
...
def iterative_enhance():
    ...
    output_ppm_path = r'C:\Users\Saksham\Desktop\SharpView\SharpView-Advance-Low-Light-Image-Enhancer\iterative_output.ppm'
